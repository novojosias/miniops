...
const Header = () => {
  ...
  return (
    <>
      <motion.header
        className={`fixed top-0 left-0 w-full z-40 transition-colors duration-300 ${isScrolled ? 'bg-[#0C0D0D]/80 backdrop-blur-lg border-b border-white/10' : 'bg-transparent border-b border-gray-200'}`}
      >
